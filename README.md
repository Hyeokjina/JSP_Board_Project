# 🚀 JSP 커뮤니티
> 회원 관리와 게시판 기능을 갖춘 JSP 기반 웹 애플리케이션 만들기!
> 
<sub>해당 주소는 jsp작업 이후 mybtis를 사용해 최적화하여 게시판을 만들었다.
([https://github.com/Hyeokjina/JSP_Board_Project-mybatis-](https://github.com/Hyeokjina/JSP_Board_Project-mybatis-))</sub>
## 📘 개요 (Overview)
